...
const LosersPage = () => {
  ...
  // init
  useEffect(() => {
    getTopStocks(selectedExchange.id, false).then(result => setStocks([...result]));
  }, [selectedExchange]);
  ...
  return (
    <div>
      <h1 className='text-center text-4xl text-white'>Top stock-losers</h1>
      <p className='mt-1 text-center font-light text-base text-cyan'>
        The list of ten stocks that fell the most in price over the last day
      </p>
